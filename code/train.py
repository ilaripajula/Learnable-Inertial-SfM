            ...
            for curr_data in batch_data:
                ...
                if save_predictions:
                    ...
                    if conf.get_bool('dataset.calibrated'):
                        ...
                        if epoch != 0 and 'IMU_refined_pose' in pred_cam.keys():
                            path = plot_utils.plot_refined_pose(outputs, errors, conf, phase, scan=curr_data.scan_name, epoch=epoch+1, bundle_adjustment=bundle_adjustment)
